...
public enum PropertyKey {
   // Network
   KEY_NET_RCV_BUFFER_SIZE("net_recv_buffer_size", "2048"),
   KEY_NET_SND_BUFFER_SIZE("net_send_buffer_size", "512"),
   ...
   KEY_NET_HTTP_PORT("net_http_port", "8080"),
    ...
    KEY_MIC_SAMPLE_SIZE("microphone_sample_size", "16"),    // bits
    KEY_MIC_UDP_PORT("microphone_UDP_port", "8080"),
